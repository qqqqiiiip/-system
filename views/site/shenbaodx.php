...
<div class="site-index">
    ...
    <div class="body-content">
        ...
        <button id="export" class="btn-success btn-sm btn"><a target="_blank" href="/basic/web/index.php?r=site/export&type=musedx&condition=<?= Html::encode(json_encode($condition)) ?>">导出excel</a></button>
